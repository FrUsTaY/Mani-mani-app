...
with open('app/src/main/java/com/example/ui/util/Helpers.kt', 'r') as f:
    content = f.read()

new_icon_helper = """object IconHelper {
...
# Use regex to replace object IconHelper { ... }
new_content = re.sub(r'object IconHelper \{.*\}', new_icon_helper, content, flags=re.DOTALL)

with open('app/src/main/java/com/example/ui/util/Helpers.kt', 'w') as f:
    f.write(new_content)
